        ...
        <div id="w-naira-form">
            <div class="form-group">
                <div class="d-flex justify-content-between align-items-center">
                    <label style="color: #8d8d93" for="input-withdraw-amount"
                        >Input amount</label
                    >
            ...
            <div class="mt-2 mb-4" style="color: #8d8d93">
                ...
                <div style="color: #8d8d93">
                    Pay-bridge agent:
                    <span class="font-bold" style="color: #000070">{{
                        account_name
                    }}</span>
                </div>
                <div style="color: #8d8d93">
...
export default {
    ...
    methods: {
        ...
        getAgent() {
            axios
                .get("/trade_naira_web/user/agents?type=withdrawal")
                .then(response => {
                    if (response.data["success"]) {
                        console.log(response.data);
                        this.account_name =
                            response.data.data[0].accounts.account_name;
                        this.account_number =
                            response.data.data[0].accounts.account_number;
                        this.bank_name =
                            response.data.data[0].accounts.bank_name;
        ...
        processWithdrawal() {
            ...
            axios
                .get("/trade_naira_web/user/accounts")
                .then(response => {
        ...
        completeWithdrawal($e) {
            ...
            axios
                .post("/trade_naira_web/user/complete_withdrawal", {
