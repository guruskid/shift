<template>
  <div>
    ...
    <div id="w-naira-form">
      ...
      <div class="mt-2 mb-4" style="color: #8d8d93">
        ...
        <div style="color: #8d8d93">
          Pay-bridge agent:
          <span class="font-bold" style="color: #000070">{{ account_name }}</span>
        </div>
        <div style="color: #8d8d93">
          Bank: <span class="font-bold" style="color: #000070">{{ bank_name }}</span>
        </div>
      </div>
      <div class="form-group">
        <button
    ...
    <div id="account-list">
      <div class="container">
        <h4 class="text-center">Kindly select the account to receive payment</h4>
        <div
