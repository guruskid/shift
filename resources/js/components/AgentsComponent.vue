                ...
                <div class="tab-pane fade show active" id="personal-chat" role="tabpanel"
                    ...
                    <div class="sidebar-userlist">
                        <ul class="list-unstyled userSearchList">
                            <li v-for="user in users" :key="user.withUser.id" :id="user.id"  @click="userMessage(user.withUser.id)" >
                                    ...
                                    <div class="conversation__details">
                                        ...
                                        <div class="conversation__message">
                                            <div class="conversation__message-preview">
                                                <span class="tick">
                                                    <img v-if="user.thread.is_seen == 1 && user.thread.user_id == user_id"
                                                        src="/chat/assets/images/tick/tick-read.svg" alt="">
                                                    <img v-else-if="user.thread.user_id == user_id "
                                                        src="/chat/assets/images/tick/tick-delivered.svg" alt="">
                                                </span>
                                                <span>
                                                    {{user.thread.message}}
                                                </span>
