<template>
    <div class="container my-3 mt-lg-5 wallet_trx_tabs" id="bitcoin_wallet_send_tab">
        <form @submit.prevent="send()">
            <p class="text-warning text-center">Only send Tron to Tron (TRC20) network, sending to other network can lead to permament loss of funds </p>
            <div class="row">
                <div class="col-12 col-md-10 col-lg-8 mx-auto" style="border: 1px solid rgba(0, 0, 112, 0.25);">
                    ...
                    <div class="input-group-append">
                        ...
                        <input type="number" required step="any" @keyup="getRateTrx()" v-model="trx" placeholder="0"
                            class="form-control" style="border: 0px;border-right:0px;">
                ...
                <div class="container mt-3m mt-lg-5">
                    <div class="row">
                        ...
                        <button type="submit" v-if="!loading" class="btn walletpage_btn text-white mt-3 mt-lg-5">Send
                        </button>
                        <button disabled type="submit" v-else
                            class="btn walletpage_btn text-white mt-3 mt-lg-5">Loading... </button>
                    </div>
                </div>
            </div>
        </form>
