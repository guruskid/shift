        ...
        <form @submit.prevent="buy()" mtrxod="post">
            ...
            <div class="form-group mb-4">
                ...
                <div class="input-group mb-0 mr-sm-2">
                    <div class="input-group-prepend" style="border-radius: 30px">
                        <div class="input-group-text input_label">USDT</div>
                    </div>
                    <input type="number" required step="any" min="0" name="quantity" v-model="amt" @keyup="getRateAmt()"
                        class="form-control bitcoin-input-radius" />
                </div>
            </div>
            <div class="form-group mb-4">
                ...
                <div class="input-group mb-2 mr-sm-2">
                    <div class="input-group-prepend" style="border-radius: 30px">
                        <div class="input-group-text input_label">NGN</div>
                    </div>
            ...
            <button v-if="!loading" class="sell_submit_btn btn w-100 text-white mt-2 bitcoin_calculator_btn">
                Buy
            </button>
            <button v-else class="sell_submit_btn btn w-100 text-white mt-2 bitcoin_calculator_btn" disabled>
        ...
        methods: {
            ...
            buy() {
                ...
                axios
                    ...
                    .then((res) => {
                        if (res.data.success) {
                            swal("Great!!", "USDT bought successfully", "success");
