<template>
    <div class="container my-3 mt-lg-5 wallet_trx_tabs" id="bitcoin_wallet_send_tab">
        <p class="text-warning text-center">Only send USDT to TRC20 network, sending to other network can
                    lead to permament loss of funds </p>
            ...
            <div class="row">
                <div class="col-12 col-md-10 col-lg-8 mx-auto" style="border: 1px solid rgba(0, 0, 112, 0.25);">
                    ...
                    <div class="input-group-append">
                        ...
                        <input type="number" required step="any" @keyup="getRateAmt()" v-model="amt" placeholder="0"
