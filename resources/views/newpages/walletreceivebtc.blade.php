                        ...
                        <div class="col-12">
                            <div class="card card-body">
                                ...
                                <div class="walletpage__menu-container mx-auto mt-4">
                                    ...
                                    <div class="mt-4">
                                        <form action="">
                                            <div class="mx-auto mb-5" style="width:500px;">
                                                <span class="d-block" style="color: #000070;font-size: 16px;line-height: 22px;">Receiving wallet</span>
                                            
                                            <div class="py-3 px-2 text-center" style="font-size: 16px;color: #000070;border: 1px solid rgba(0, 0, 112, 0.25);border-radius: 5px;">
                                            ...
                                            <button type="submit" class="btn text-white mt-4 walletpage_btn" style="width: 420px;left:22%;">Confirm</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
