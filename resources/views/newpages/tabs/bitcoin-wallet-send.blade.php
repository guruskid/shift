        ...
        <div class="row">
            <div class="col-12 col-md-10 col-lg-8 mx-auto" style="border: 1px solid rgba(0, 0, 112, 0.25);">
                <div class="input-group">
                    <input type="text" aria-label="First name" class="form-control" placeholder="$0.00" style="border: 0px;">
                    ...
                    <input type="text" aria-label="Last name" placeholder="0" class="form-control" style="border: 0px;border-right:0px;">
