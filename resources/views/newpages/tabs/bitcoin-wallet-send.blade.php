<div class="container my-3 mt-lg-5 wallet_trx_tabs" id="bitcoin_wallet_send_tab">
    ...
    @else
        <h4 class="text-center p-2 text-white" style="background-color: #000070"><i class="fas fa-info-circle"></i> {{$btc_withdrawal_setting['notice']}}</h4>
    @endif
    </div>

    @section('scripts')
    <script>
        var btc_to_usd = {{ $btc_rate  }}
