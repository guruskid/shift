        ...
        <div class="row">
            ...
            <div class="col-12 col-md-8 mx-md-auto px-0 mx-0 px-lg-0 ml-lg-0 mr-lg-3 col-lg-5 mt-3">
                ...
                <div class="form-group">
                    <input type="number" class="form-control" name="decoder" placeholder="0000 0000 0000 0000"  id="decoder" onchange="getCableUser()" />
                </div>
            </div>
            ...
            <div class="col-12 col-md-8 mx-md-auto px-0 mx-0 px-lg-0 ml-lg-5 col-lg-5 mt-3">
                <label for="amount" class="mb-0 pb-0" style="color: #000070;">Owner's name</label>
                <input type="name" readonly id="owner-name" class="form-control pr-4" value="" />
            </div>
            <div class="col-12 col-md-8 mx-md-auto px-0 mx-0 px-lg-0 mx-lg-0 col-lg-5 mt-3">
                ...
                <div class="form-group mb-0">
                    ...
                    <input type="password" name="password" id="password_field2" placeholder="---" maxlength="4"
