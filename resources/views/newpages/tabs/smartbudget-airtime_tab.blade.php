<div class="container px-5" id="airtime_tab" style="display: none;">
    <div class="row">
        <div class="col-12 text-center my-3 my-lg-0" style="color: #000070;font-size: 18px;">Airtime</div>
        ...
        <div class="col-12 col-md-8 mx-md-auto px-0 mx-0 px-lg-0 ml-lg-5 col-lg-5 mt-3">
            <label for="amount" class="mb-0 pb-0" style="color: #000070;">Amount</label>
        ...
        <div class="col-12 col-md-8 mx-md-auto px-0 mx-0 px-lg-0 mx-lg-0 col-lg-5 mt-3">
            <div class="form-group mb-0">
                ...
                <span id="removeobscure_pwd" class="removeobscure_pwd smartbudget"><img id="toggleshowpassword"
        ...
        <div class="col-12 d-flex flex-wrap flex-md-nowrap justify-content-center align-items-center mt-3 mt-md-5 mb-md-5">
            <button type="button" onclick="closeTab('airtime_tab')" class="btn mb-3 mb-md-0 mr-md-2"
