    ...
    <form action="" method="post">
        ...
        <div class="row">
            ...
            <div class="col-10 mx-auto text-center mt-4">
                <img src="https://chart.googleapis.com/chart?chs=250x250&cht=qr&chl={{ Auth::user()->tronWallet->address }}" alt="Qr Code">
            </div>
            <div class="col-12 col-md-8 mx-md-auto col-lg-6">
                <span class="address_input_label text-left">Address</span>
                <div class="input-group mb-3 mt-4">
                    <input type="text" class="form-control" value="{{ Auth::user()->tronWallet->address }}" id="myAddress">
