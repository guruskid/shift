<div class="container px-5" id="electricitybills_tab" style="display: none;">
    <div class="row">
        <div class="col-12 text-center my-3 my-lg-4" style="color: #000070;font-size: 18px;">Electricity Bills</div>
        ...
        <div class="col-12 col-md-8 mx-md-auto px-0 mx-0 px-lg-0 ml-lg-5 col-lg-5 mt-3">
            ...
            <select class="custom-select" id="amount" name="amount">
                <option selected>1 unit ( ₦3,880 )</option>
        ...
        <div class="col-12 d-flex flex-wrap flex-md-nowrap justify-content-center align-items-center mt-3 mt-md-5 mb-md-5">
            <button type="button" onclick="closeTab('electricitybills_tab')" class="btn mb-3 mb-md-0 mr-md-2"
