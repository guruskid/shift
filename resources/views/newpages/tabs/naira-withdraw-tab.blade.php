<div id="nairaWithdrawTab" style="display: none;">
    <span class="d-block text-center primary_text_color mb-4" style="font-size: 20px;font-weight:500;display:none;">Withdraw</span>
<form action="" method="post">
    @csrf
    <div class="px-5 py-2" style="border: 1px solid rgba(0, 0, 112, 0.25);border-radius: 5px;">
