                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                            <div class="widget widget-chart-one">
                                <div class="widget-heading">
                                    <div>
                                        <span class="h3 giftcard-text">Binance Coin</span>
                                    </div>
                                    <div class="widget-n text-center" style="justify-content: center;">
                                        <span class="d-block" style="h6 walletbalance-text">Binance Wallet Balance</span>
                                        <span
                                            class="d-block price">{{ Auth::user()->bnbWallet ? number_format((float)Auth::user()->bnbWallet->balance, 8) : 'No Binance wallet' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="widget widget-chart-one">
                                <div class="widget-heading d-flex justify-content-between mt-2">
                                    <a href="{{ route('user.binance-wallet') }}">
                                        <button class="btn btn-primary">Send BNB</button>
                                    </a>
                                    <a href="{{ route('user.binance-wallet') }}">
                                        <button class="btn btn-primary">Receive BNB</button>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="widget widget-chart-one">
                                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-center pb-2"
                                    ...
                                    <div class="list-cards-title primary-color" style="line-height: 40px;">
                                        <span class="ml-1" style="color: rgba(0, 0, 112, 0.75);">Buy/Sell Binance Coin</span>
                                    </div>
                                </div>
                                ...
                                <p class="text-danger text-center">Please create a Binance Coin wallet before initiating a
                                ...
                                <div>
                                    ...
                                    <div class="tab-content " id="myTabContent">
                                        ...
                                        <binance-sell-component :rate="{{ $sell_rate }}" :bnb_usd="{{ $bnb_usd }}"  :charge={{ $charge }} :hd="'{{ $hd_wallet }}'" ></binance-sell-component>
