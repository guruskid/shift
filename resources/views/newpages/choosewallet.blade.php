                                    ...
                                    <div class="col-10 px-1 col-lg-4 mx-auto py-2 mt-5" style="box-shadow: 0px 2px 10px rgba(207, 207, 207, 0.25);border-radius: 5px;">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <span class="pt-0 mt-0 choosewallet_selection_amnt_equiv">500,560 </span><span style="color: #000070;">NGN</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-10 px-1 col-lg-4 mx-auto py-2 mt-4" style="box-shadow: 0px 2px 10px rgba(207, 207, 207, 0.25);border-radius: 5px;">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div>
                                                <span class="pt-0 mt-0 choosewallet_selection_amnt_equiv">0.00 </span><span style="color: #000070;">BTC</span>
                                                </div>
                                                <span class="pt-0 mt-0 choosewallet_selection_ngn_equiv">NGN </span><span style="color: #000070;">30,909</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
