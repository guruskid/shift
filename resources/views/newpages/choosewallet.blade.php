                                    ...
                                    <div class="row">
                                        <div class="col-10 px-1 col-lg-4 mx-auto py-2 mt-4"
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <span
                                                        class="d-block pb-0 mb-0 choosewallet_selection">{{  number_format((float)$bnb_wallet->balance, 5)  }} ETH</span>
                                                    <div>
                                                        <span
