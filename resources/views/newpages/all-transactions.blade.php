                                            ...
                                            <form action="{{ route('user.transactions') }}" method="get">
                                                <div class="d-flex flex-column flex-lg-row justify-content-center align-items-center"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="">
                                                            <input type="date" class="form-control col-10"
                                                    ...
                                                    <tbody>
                                                        @foreach ($transactions as $transaction)
                                                            <tr>
                                                                ...
                                                                @if (\Str::lower($transaction->type) == 'sell')
                                                                ...
                                                                <td style="display: flex;">
                                                                    ...
                                                                    @if ($transaction->status == 'failed')
                                                                        <span style="margin-left: -24px; margin-top: -16px"
                                                                            data-toggle="tooltip" data-type="info"
                                                                            title="{{ $transaction->feedback }}"
                                                                            class="btn rounded-pill"><i
                                                                                style="font-size:16px; "
                                                                                class="text-danger fa fa-info-circle"></i></span>
                                                                    @endif
                                                                    @if ($transaction->status == 'declined')
                                                                        <span data-toggle="tooltip"
                                                                            title="{{ $transaction->feedback }}"
                                                                            data-type="info"
                                                                            style="margin-left: -25px; postion: absolute; margin-top: -16px"
                                                                            class="btn rounded-pill"><i
                                                                                style="font-size:16px; "
                                                                                class="text-danger fa fa-info-circle"></i></span>
                                                                    @endif
