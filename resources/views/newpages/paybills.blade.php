                                                    ...
                                                    <div class="row mt-2 mt-md-5">
                                                        <form action="" method="post">
                                                            ...
                                                            <div class="row mt-3 mt-md-4">
                                                                ...
                                                                <div class="col-12 my-1 my-md-0 col-lg">
                                                                    <label for="metre_type" class="mb-0 pb-0"
                                                                        style="color: #000070;">Phone number</label>
                                                            ...
                                                            <div
                                                                class="form-group col-12 my-1 my-md-0 col-md-6 mr-auto ml-0 pl-0 mt-md-4">
                                                                <label for="pin" class="mb-0 pb-0"
                                                                    style="color: #000070;">Pin</label>
                                                                <span id="pwd_visibility_toggle"
                                                                    class="pwd_visibility_toggle">
