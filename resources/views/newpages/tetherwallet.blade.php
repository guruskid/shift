                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                            <div class="widget widget-chart-one">
                                <div class="widget-heading">
                                    <div>
                                        <span class="h3 giftcard-text" style="color: #000070;">Tether Wallet portfolio</span>
                                    </div>
                                    <div class="widget-n" style="justify-content: center; text-align: center;">
                                        <span class="d-block" style="h6 walletbalance-text">Wallet Balance</span>
                                        <span class="d-block price">₦37500</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="walletpage__menu-container mx-auto mt-4">
                                    <div class="walletpage_menu d-flex flex-column flex-md-row justify-content-center justify-content-md-between align-items-center">
                                        <div class="mb-4 mb-lg-0">
                                            <span class="d-block" style="color: #565656;font-size: 16px;">Tether wallet Balance</span>
                                            <span class="d-block">
                                                <span style="color: #000070;font-size: 30px;">50,000</span>
                                                <span style="color: #000070;font-size: 30px;">USDT</span>
                                            </span>
                                            <span class="d-block"
                                    ...
                                    @include('newpages.tabs.tether-wallet-send')
                                    @include('newpages.tabs.tether-wallet-receive')
