                    ...
                    <div class="row layout-top-spacing">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                            <div class="widget widget-chart-one">
                                <div class="widget-heading">
                                    <div>
                                        <span class="h3 giftcard-text" style="color: #000070;">Binance Wallet</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="card card-body">
                                ...
                                <div class="walletpage__menu-container mx-auto mt-4">
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <a href="{{ route('binance.trade') }}" class="btn">
                                                <span class="d-block">
                                ...
                                <binance-send-component :usd_eth="{{ $bnb_rate }}" ></binance-send-component>

                                @include('newpages.tabs.binance-wallet-receive')
