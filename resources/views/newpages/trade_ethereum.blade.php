                            ...
                            <div class="widget widget-chart-one">
                                <div class="widget-heading">
                                    ...
                                    <div class="widget-n text-center" style="justify-content: center;">
                                        <span class="d-block" style="h6 walletbalance-text">Ethereum Wallet Balance</span>
                                        <span
                                            class="d-block price">{{ Auth::user()->ethWallet ? number_format((float)Auth::user()->ethWallet->balance, 8) : 'No Ethereum wallet' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                            <div class="widget widget-chart-one">
                                <div class="widget-heading d-flex justify-content-between mt-2">
                                    ...
                                    <a href="{{ route('user.ethereum-wallet') }}">
                                        <button class="btn btn-primary">Receive ETH</button>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="widget widget-chart-one">
                                ...
                                <p class="text-danger text-center">Please create a Ethereum wallet before initiating a
