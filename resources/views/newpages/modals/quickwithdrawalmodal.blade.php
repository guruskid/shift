                    ...
                    <div class="row">
                        <div class="col-10">
                            <div class="form-check my-2">
                                <input class="form-check-input" type="radio" name="rechargemyself" id="rechargeme" value="recharge_myself" checked/>
                                <label class="form-check-label" style="color: #000070;font-size: 16px;" for="rechargeme">
                                  Emeka Emekus Jigawa - 0029345812 - UBA
                                </label>
                            </div>
                            <div class="form-check my-2">
                                ...
                                <label class="form-check-label" style="color: #000070;font-size: 16px;" for="other">
                                  Muhammedd Buhari - 0983744688 - FCMB
                                </label>
                            </div>
                        </div>
                        ...
                        <form>
                            ...
                            <div class="form-row">
                              <div class="col">
                                ...
                                <select name="" id="amount" class="wdselectamount custom-select">
                                    <option value="10">10</option>
                                </select>
                              </div>
                              <div class="col">
                                <label for="pin" style="color: #000070;letter-spacing: 0.01em;">Pin</label>
                                <input type="password" id="wdpin" class="form-control" style="padding-right:30px;" />
