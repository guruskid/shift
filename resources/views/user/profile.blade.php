                                ...
                                <div class="col-md-3">
                                    <div class="user-balance-box">
                                        ...
                                        <div class="box-3">
                                            ...
                                            <button class="btn btn-block btn-secondary" data-toggle="modal"
                                                data-target="#change-password-modal"><i class="fa fa-money-bill"></i>
                                                Wallet
                                                password</button>
                                        </div>
                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="custom-control custom-switch">
                                                                        <input type="checkbox"
                                                                            ...
                                                                            onclick="notSw('w-s')"
                                                                            class="custom-control-input" id="w-s">
                                                                ...
                                                                <td>
                                                                    <div class="custom-control custom-switch">
                                                                        <input type="checkbox"
                                                                            ...
                                                                            onclick="notSw('w-e')"
                                                                            class="custom-control-input" id="w-e">
                                                                        <label class="custom-control-label"
                                                                            for="w-e"></label>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <div class="custom-control custom-switch">
                                                                        <input type="checkbox"
                                                                            ...
                                                                            onclick="notSw('t-s')"
                                                                            class="custom-control-input" id="t-s">
                                                                        <label class="custom-control-label"
                                                                            for="t-s"></label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="custom-control custom-switch">
                                                                        <input type="checkbox"
                                                                            ...
                                                                            onclick="notSw('t-e')"
                                                                            class="custom-control-input" id="t-e">
                                                                        <label class="custom-control-label"
                                                                            for="t-e"></label>
                                                                    </div>
                                                                </td>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="card card-body">
                                                                ...
                                                                <button class="btn btn-custom-accent"
                                                                    data-toggle="modal"
                                                                    data-target="#reset-email-modal">Set up</button>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <form id="user-bank-details" class="mb-4">
                    ...
                    <div class="form-row ">
                        ...
                        <div class="col-md-12">
                            <div class="position-relative form-group">
                                <label>Account Number</label>
                                <input type="text" required id="account-number" class="form-control"
                                    name="account_number">
                            </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" placeholder="- - - -" required
                                    name="new_password" minlength="4" maxlength="4">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
...
<div class="modal fade " id="reset-email-modal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content  c-rounded">
            ...
            <!-- Modal body -->
            <div class="modal-body">
                <form action="{{route('user.reset-email')}}" class="ml-3" method="POST">
                    @csrf
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control form-control" name="new_email" required>
                    </div>
                    <button class="btn btn-block c-rounded bg-custom-gradient">
                        Update Email
                    </button>
