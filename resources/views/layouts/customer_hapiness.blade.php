...
<head>
    ...
    @if (Route::currentRouteName() == 'customerHappiness.chatdetails')
     <link href="{{ asset('admin_assets/css/customer_hapiness.css') }} " rel="stylesheet" type="text/css" />   
    @endif
    ...
    <div class="main-container" id="container">
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                @include('layouts.partials.customer_happiness_sidebar')
                @endif
