<ul class="list-unstyled menu-categories" id="accordionExample">
    ...
    <li class="menu {{ Route::currentRouteName() == 'admin.binance' ? 'active' : '' }}  ">
        <a href="{{route('admin.binance')}}"  aria-expanded="false" class="dropdown-toggle">
            <div class="">
                <img src="/svg/bnb.png" height="20px" class="mr-4" alt="">
                <span>Binance Wallet <span class="badge badge-warning">New</span></span>
            </div>
        </a>
    </li>
