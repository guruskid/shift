<ul class="list-unstyled menu-categories" id="accordionExample">
    ...
    <li class="menu {{ Route::currentRouteName() == 'sales.call-log' ? 'active' : '' }}  ">
        <a href="{{route('sales.call-log')}}" aria-expanded="false" class="dropdown-toggle">
            <div class="">
    ...
    <li class="menu {{ Route::currentRouteName() == 'business-developer.user-profile' ? 'active' : '' }}  ">
        <a href="{{route('sales.user_profile')}}" aria-expanded="false" class="dropdown-toggle">
            <div class="">
