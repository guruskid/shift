                ...
                <form id="signup_form" method="POST" action="{{route('register')}}">
                    ...
                    <div id="step_one">
                        <div class="form-group">
                            <input type="text" onkeypress="return event.charCode != 32" name="first_name" required placeholder="First Name" class="form-control col-11 mx-auto mx-md-0 col-lg-8">
                        </div>
