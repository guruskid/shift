    ...
    <div class="layout-px-spacing">
        ...
        <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="td-content">
                                                ...
                                                @case('success')
                                                <span
                                                    class="badge badge-success text-uppercase">{{$t->status}}</span>
                                                @break
                                                @case("failed")
                                                <span
                                                    class="badge badge-danger text-uppercase">{{$t->status}}</span>
                                                @break
                                                @case('declined')
                                                <span
                                                    class="badge badge-warning text-uppercase">{{$t->status}}</span>
                                                @break
                                                @case('waiting')
                                                <span
                                                    class="badge badge-info text-uppercase">{{$t->status}}</span>
                                                @break
                                                @default
                                                <span
                                                    class="badge badge-success text-uppercase">{{$t->status}}</span>
            ...
            <div class="col-md-6">
                <div class="widget widget-table-two">
                    <div class="widget-heading">
                        <h5 class="">APPROVED TRANSACTIONS </h5>
                    </div>
                    ...
                    <div class="widget-content">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach ($approved_transactions as $t)
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name">{{ucwords($t->card)}}</div>
                                        </td>
                            ...
                            <div class="View-all">
                                <a href="{{route('admin.transactions-status', 'approved')}}">View all </a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <div class="th-content th-heading">Prey.Bal</div>
                                        </th>
                                        <th>
                                            <div class="th-content">Cur.Bal</div>
                                        </th>
                                        <th>
                                            <div class="th-content">Status</div>
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name">{{ucwords($t->transactionType->name)}}
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="td-content pricing"><span
                                                    class="">₦{{number_format($t->previous_balance) }}</span></div>
                                        </td>
                                        <td>
                                            <div class="td-content pricing"><span
                                                    class="">₦{{number_format($t->current_balance)}}</span></div>
                                        </td>
                                        <td>
                                            <div class="td-content"><span class="badge badge-success">{{$t->status}}
                                                </span></div>
                                        </td>
                                    </tr>
                                    @endforeach
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <div class="th-content th-heading">Wallet Balance</div>
                                        </th>
                                        <th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"><a
                                                    href=" {{route('admin.user', [$u->id, $u->email ] )}} ">
                                                    {{ucwords(Str::limit($u->first_name, 10, '..') )}}</a></div>
                                        </td>
                                        <td>
                                            <div class="td-content product-brand">{{Str::limit($u->email, 12, '...') }}
                                            </div>
                                        </td>
                                        <td>
                                            <div class="td-content">{{$u->phone}}</div>
                                        </td>
                                        <td>
                                            <div class="td-content pricing"><span
                                                    class="">₦{{$u->nairaWallet ? number_format($u->nairaWallet->amount) : 0 }}</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="td-content pricing"><span
                                                    class="">{{$u->created_at->format('d m')}}</span></div>
                                        </td>
                                    </tr>
                                    @endforeach
                            ...
                            <table class="table">
                                <tbody>
                                    <tr class="border">
                                        ...
                                        <td>
                                            <div class="td-content total">
                                                <h5 class="buy-n">₦{{number_format($buyCash)}}</h5>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="td-content total">
                                        ...
                                        <td>
                                            <div class="td-content total">
                                                <h5 class="sell-n">₦{{number_format($sellCash)}}</h5>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="td-content total">
                                                <h5 class="user">TOTAL USERS</h5>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="td-content total">
                                                <h5 class="sell-n">{{$sellCount}}</h5>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="td-content total">
                                                <h5 class="user-n">{{$users_count}}</h5>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
