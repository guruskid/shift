    ...
    <div class="layout-px-spacing">
        ...
        <div class="dashboard-title d-flex">
            ...
            <div class="row layout-top-spacing">
                ...
                onclick="window.location = '{{ route('sales.user-category',['type'=>'all_user']) }}'">
                ...
                <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing"
                onclick="window.location = '{{ route('sales.user-category',['type'=>'called_user']) }}'">
                ...
                <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing"
                onclick="window.location = '{{ route('sales.user-category',['type'=>'pending_user']) }}'">
                ...
                <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing"
                onclick="window.location = '{{ route('sales.user-category',['type'=>'good_lead']) }}'">
                ...
                <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing"
                onclick="window.location = '{{ route('sales.user-category',['type'=>'bad_lead']) }}'">
                ...
                <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing"
                onclick="window.location = '{{ route('sales.user-category',['type'=>'traded_user']) }}'">
