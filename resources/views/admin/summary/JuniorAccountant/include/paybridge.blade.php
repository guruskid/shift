                ...
                <table class="table ">
                    ...
                    <tbody>
                        <tr>
                                ...
                                <td class="text-center">[{{ isset($payBridgeTransactionsPendingAmount) ? number_format($payBridgeTransactionsPendingAmount) :0 }}] ₦ {{ isset($payBridgeTransactionsPendingCount) ? number_format($payBridgeTransactionsPendingCount) :0 }}</td>
