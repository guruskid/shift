                        ...
                        <div class="card-body">
                           <form action="{{ route('admin.junior-summary-sort-details') }}" method="POST">
                                ...
                                <div class="form-inline mb-3">
                                    ...
                                    <input type="datetime-local" name="startdate" class="form-control mr-4" required>

                                    <label class="mr-2">End Date</label>
                                    <input type="datetime-local" name="enddate" class="form-control mr-4" required>
                                    ...
                                    <button class="btn btn-primary ml-1">Sort</button>
                                </div>
                           </form>
                            <ul class="nav nav-tabs nav-justified">
                                <li class="nav-item"><a data-toggle="tab" href="#tab-eg11-0"
                                        class="active nav-link">Crypto and Giftcard Transactions</a>
                                </li>
                                <li class="nav-item"><a data-toggle="tab" href="#tab-eg11-1" class="nav-link">Utility Transactions</a>
                                </li>
                                <li class="nav-item"><a data-toggle="tab" href="#tab-eg11-2" class="nav-link">Pay Bridge Transactions</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tab-eg11-2" role="tabpanel">
                                    ...
                                    <ul class="nav nav-tabs nav-justified">
                                        <li class="active nav-item"><a data-toggle="tab" href="#home">Deposit</a></li>
                                        <li class="nav-item"><a data-toggle="tab" href="#menu1">Withdrawal</a></li>
                                        <li class="nav-item"><a data-toggle="tab" href="#menu2">Others</a></li>
                                    </ul>
