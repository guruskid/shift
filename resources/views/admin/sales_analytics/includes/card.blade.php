<div class="row">
    ...
    onclick="window.location = '{{route('sales.newUsers.salesAnalytics',['type'=>'calledUsers'])}}'" >
    @if ($type == "calledUsers")
    ...
    {{-- No of good Leads --}}
    <div class="col-md-3 col-xl-3 to_trans_page"
    onclick="window.location = '{{route('sales.newUsers.salesAnalytics',['type'=>'GoodLead'])}}'" >
         @if ($type == "GoodLead")
        <div class="card mb-3 widget-content  bg-amy-crisp">
        @else
        <div class="card mb-3 widget-content  bg-secondary">
    ...
    onclick="window.location = '{{route('sales.newUsers.salesAnalytics',['type'=>'GLConversion'])}}'" >
    ...
    {{-- No of Bad Leads --}}
    <div class="col-md-2 col-xl-2 to_trans_page"
    onclick="window.location = '{{route('sales.newUsers.salesAnalytics',['type'=>'BadLead'])}}'" >
        @if ($type == "BadLead")
        <div class="card mb-3 widget-content  bg-amy-crisp">
        @else
        <div class="card mb-3 widget-content  bg-secondary">
    ...
    <div class="col-md-2 col-xl-2 to_trans_page"
    onclick="window.location = '{{route('sales.newUsers.salesAnalytics',['type'=>'ATBC'])}}'" >
        @if ($type == "ATBC")
        <div class="card mb-3 widget-content  bg-amy-crisp">
        @else
        <div class="card mb-3 widget-content  bg-secondary">
    ...
    {{-- Bad Lead Conversion --}}
    <div class="col-md-3 col-xl-3 to_trans_page"
    onclick="window.location = '{{route('sales.newUsers.salesAnalytics',['type'=>'BLConversion'])}}'" >
    ...
    <div class="col-md-3 col-xl-3 to_trans_page"
    onclick="window.location = '{{route('sales.newUsers.salesAnalytics',['type'=>'TCR'])}}'" >
        @if ($type == "TCR")
        <div class="card mb-3 widget-content  bg-amy-crisp">
        @else
        <div class="card mb-3 widget-content  bg-secondary">
    ...
    <div class="col-md-2 col-xl-2 to_trans_page"
    onclick="window.location = '{{route('sales.newUsers.salesAnalytics',['type'=>'TCV'])}}'" >
        @if ($type == "TCV")
        <div class="card mb-3 widget-content  bg-amy-crisp">
        @else
        <div class="card mb-3 widget-content  bg-secondary">
    ...
    {{-- total Call Duration --}}
    <div class="col-md-2 col-xl-2 to_trans_page"
    onclick="window.location = '{{route('sales.newUsers.salesAnalytics',['type'=>'TCD'])}}'" >
        @if ($type == "TCD")
        <div class="card mb-3 widget-content  bg-amy-crisp">
        @else
        <div class="card mb-3 widget-content  bg-secondary">
    ...
    {{-- AverageCallDuration --}}
    <div class="col-md-2 col-xl-2 to_trans_page"
    onclick="window.location = '{{route('sales.newUsers.salesAnalytics',['type'=>'ACD'])}}'" >
        @if ($type == "ACD")
        <div class="card mb-3 widget-content  bg-amy-crisp">
        @else
        <div class="card mb-3 widget-content  bg-secondary">
