                                ...
                                <tbody>
                                    @foreach ($transactions as $txn)
                                        ...
                                        <tr class="{{ $status }} ">
                                            ...
                                            <td>{{ ucwords($txn->transactionType->name) }}</td>
                                            <td>₦{{ number_format($txn->user->nairaWallet->amount) }} </td>
                                            <td>
                                                <div class="btn-group">
                                                    <a class="btn btn-alternate"
                                                        href=" {{ route('admin.user', [$txn->user->id, $txn->user->email]) }} ">View</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
