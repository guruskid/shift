            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="main-card p-3 mb-3 card">
                                <form action=" {{route('admin.add_rate')}} " method="POST" class=" mb-3">
                                    {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col-3">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="">USD</label>
                                                <input type="number" placeholder="USD" required class="form-control" name="usd">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="">EUR</label>
                                                <input type="number" placeholder="EUR" class="form-control" name="eur">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="">GBP</label>
                                                <input type="number" placeholder="GBP" class="form-control" name="gbp">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="">AUD</label>
                                                <input type="number" placeholder="AUD" class="form-control" name="aud">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="">CAD</label>
                                                <input type="number" placeholder="CAD" class="form-control" name="cad">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="">Min</label>
                                                <input type="number" placeholder="Minimum value" required class="form-control" name="min">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="">Max</label>
                                                <input type="number" placeholder="Maximum value" required class="form-control" name="max">
                                            </div>
                                        </div>
                                    </div>

                                    <button type="submit" class="btn-outline-primary btn ">Add</button>
                                </form>
